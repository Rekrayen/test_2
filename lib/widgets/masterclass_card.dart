                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        icon: Icon(
                          favoriteManager.isFavorite(masterClass.id)
                              ? Icons.favorite
                              : Icons.favorite_border,
                          color: favoriteManager.isFavorite(masterClass.id)
                              ? Colors.red
                              : Colors.grey,
                        ),
                        onPressed: () {
                          favoriteManager.toggleFavorite(masterClass.id);
                        },
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          fontWeight: FontWeight.bold,
                          color:
                              masterClass.isFree ? Colors.green : Colors.black,
                        ),
                      ),
                    ],
                  ),
                    ...
                    builder: (context, cart, child) => ElevatedButton(
                      onPressed: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                                'Добавлено в корзину: ${masterClass.title}'),
